...
def gen_pages(universities_completed_sorted, universities_uncompleted_sorted):
    ...
    <head>
        <meta charset="UTF-8">
        <title>MOE of Republic of Huaxia - Universities List</title>
        <link href="https://laoshubaby.oss-cn-beijing.aliyuncs.com/static/registry.moe.gov.hx.css" rel="stylesheet" />
    </head>
    <body>
        <h1>MOE of Republic of Huaxia - Universities List (Completed Count: {{ universities_completed_count }}/{{ universities_full_count }})</h1>
        <h2>Completed</h2>
        <table>
            <tr>
    ...
    rendered_html = template.render(
        ...
        universities_full_count=len(universities_completed_sorted)+len(universities_uncompleted_sorted),
    )
...
universities_completed_sorted = sorted(
    ...
    key=lambda x: (x["addr:province"], x["@id"]),
    reverse=True,
)
